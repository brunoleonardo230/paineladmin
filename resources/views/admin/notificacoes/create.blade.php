...
@section('content')
    ...
    <div class="ibox float-e-margins wrapper wrapper-content">
        ...
        <div class="ibox-content">
            <form action="{{ url('/admin/notificacoes/create') }}" method="POST" id="form">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 @if ($errors->has('dta_ini')) has-error @endif">
                        ...
                        <div class="input-group col-lg-12">
                            <input type="text" name="dta_ini" id="dta_ini" class="form-control date" value="{{ old('dta_ini') }}">
                    ...
                    <div class="form-group col-md-3 @if ($errors->has('dta_fim')) has-error @endif">
                        ...
                        <div class="input-group col-lg-12">
                            <input type="text" name="dta_fim" id="dta_fim" class="form-control date" value="{{ old('dta_fim') }}">
                ...
                <div class="form-group @if ($errors->has('str_mensagem')) has-error @endif">
                    ...
                    <div class="input-group col-lg-12">
                        <textarea name="str_mensagem" id="str_mensagem" class="form-control">{{ old('str_mensagem') }}</textarea>
                ...
                <div class="form-group @if ($errors->has('bol_ativo')) has-error @endif">
                    ...
                    <div class="input-group col-lg-12">
                        <select name="ind_tipo" id="ind_tipo" class="form-control" aria-required="true" required>
                            <option value="M">Nova Funcionalidade</option>
                            <option value="C">Alteração/Correção de Bug</option>
                        </select>
