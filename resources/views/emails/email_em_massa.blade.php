            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="padding: 0 0 20px; text-align: center;">
                        ...
                        <!-- <a href="http://app.stc.ma.gov.br/auth/login" style="text-decoration: none;color: #FFF;background-color: #1ab394;border: solid #1ab394;border-width: 5px 10px;line-height: 2;text-align: center;cursor: pointer;display: inline-block;border-radius: 5px;"> -->
