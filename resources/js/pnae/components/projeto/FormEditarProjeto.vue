					...
					<div class="m-portlet">
						...
						<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
							<div class="m-portlet__body">
								<div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12">
                                        ...
                                        <select disabled v-model="editalAux" @change="selectEditalProdutos()" id="editalAux" class="form-control m-input m-input--square ">
                            ...
                            <div class="form-group m-form__group row">
                                 ...
                                 <!-- Modal Novo Produto -->
                                 <div class="modal fade" data-backdrop="static" id="novo-produto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                 ...
                                                 <div class="form-group row">
                                                     <div class="col-lg-6">
                                                         ...
                                                         <select @change="changeProduto()" id="produto" v-model="novo_produto.has_produto" name="produto" class="form-control m-input">
                                                             ...
                                                             <option v-for="produto in produtos" :value="produto.has_produto">
                                                         ...
                                                         <div class="input-group m-input-group">
                                                             ...
                                                             <div class="input-group-prepend">
                                                                 <span class="input-group-text">
                                                                     {{novo_produto.has_produto.has_produto ? novo_produto.has_produto.has_produto.has_unidade_medida.sigla : "kg"}}
                                                                 </span>
                                                             </div>
                                                         </div>
                                                         <span class="m-form__help">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr v-for="(prod, key) in projeto.has_projeto_produto">
                                                ...
                                                <td>
                                                    {{prod.quantidade}} {{prod.has_produto.has_unidade_medida.sigla}}
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="First group">
                                                        ...
                                                        <button type="button" @click="deletarProjetoProduto(prod.projeto_produtos_id, key)" class="m-btn btn btn-sm btn-danger">
...
<script>
    export default {
        ...
        methods : {
            deletarProjetoProduto : function(projeto_produtos_id, key){
                Swal({
                    title: this.titulo+'?',
                    type: 'question',
                    ...
                    preConfirm: () => {
                        return self.$http.post(urlBase + '/pnae/projetos/projeto-produtos/deletar/'+projeto_produtos_id).then((response) => {
            ...
            editProduto : function(prod, key){
                self = this;
                var p = {
                    projeto_produtos_id: prod.projeto_produtos_id,
                    produto_id: prod.produto_id,
                    projeto_id: prod.projeto_id,
                    quantidade: prod.quantidade,
                    valor_unitario: prod.valor_unitario,
                    data_inicial_entrega: prod.data_inicial_entrega,
                    data_final_entrega: prod.data_final_entrega,
                    cronograma_entrega_id: prod.cronograma_entrega_id,
                    created_at: prod.created_at,
                    updated_at: prod.updated_at,
                    deleted_at: prod.deleted_at,
                    has_cronograma_entrega: prod.has_cronograma_entrega,
                    has_produto: prod.has_produto,
                    key: key
                };
                self.novo_produto = p;
                self.checkQtdProdutoFornecido();
            },
            removeProduto : function(key){
                self = this;
                self.projeto.produtos.splice(key, 1);
            },
            setProduto : function(){
                self = this;
                var retorno = false;
            ...
            salvar : function() {
                self = this;
                self.projeto.valor_total_projeto = 0;
                self.projeto.has_projeto_produto.forEach(function(produto){
                    var valor = 0;
                    valor = parseFloat(produto.valor_unitario) * produto.quantidade;
            ...
            changeProduto : function(){
                self = this;
                // console.log(this.novo_produto.has_produto);
                var valor = 0;

                self.produtos.forEach(function(p){
                    if (p.produto_id == self.novo_produto.has_produto.produto_id) {
                        valor = p.valor;
                    }
                });
                this.novo_produto.valor_unitario = valor;
                this.checkQtdProdutoFornecido();
            },
            selectEditalProdutos : function(){
                this.projeto.edital_id = this.editalAux.edital_id;
                this.produtos = this.editalAux.edital_has_produto;
            },
            ...
            checkEdit : function() {
                ...
                this.projeto = dados;
                this.editalAux = dados.has_edital;
                this.selectEditalProdutos();
