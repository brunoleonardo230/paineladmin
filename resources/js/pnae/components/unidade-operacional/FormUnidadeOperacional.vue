<template>
    <div id="form-unidade-operacional">
        <div class="m-content">
			<div class="row">
				<div class="col-lg-12">
					<div class="m-portlet">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-4 col-xl-4 col-md-12">
										...
										<input type="text" v-model="unidade_operacional.sigla" class="form-control m-input" placeholder="Digite a sigla">
										<span class="m-form__help">
											Digite a sigla
										</span>
									</div>
