        ...
        methods : {
            ...
            checkEdit : function() {
                ...
                if (this.dados) {
                    ...
                    this.cronograma.cronograma_entrega_id   = dados.cronograma_entrega_id;
                    this.cronograma.frequencia              = dados.frequencia;
                    this.cronograma.descricao               = dados.descricao;
                    this.cronograma.qtde_dias               = dados.qtde_dias;
                }
            },
        },
        mounted () {
