                    ...
                    <div class="m-portlet m-portlet--mobile">
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">
                                        Relatório Produtos Contratados
                                    </h3>
                                </div>
                            </div>
                            <div class="m-portlet__head-tools">
                        ...
                        <div class="m-portlet__body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr v-else v-for="projeto_produto in projeto_produtos.data">
                                                    <td>
                                                        {{ projeto_produto.has_projeto.has_edital.titulo }}
                                                    </td>
                                                    <td>
                                                        {{ projeto_produto.has_produto.produto }}
                                                    </td>
                                                    <td>
                                                        {{ projeto_produto.has_projeto.has_fornecedor.nome }}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ projeto_produto.data_inicial_entrega | date}}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ projeto_produto.data_final_entrega | date }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <pagination v-if="qtdeProjetoProduto > 0" :data="projeto_produtos" @pagination-change-page="filtrar"></pagination>
    ...
    export default {
        ...
        methods : {
            filtrar(page = 1) {
                self = this;
                self.loading = true;
                var url = urlBase + '/pnae/produtos-contratados/filtrar?page=' + page;

                self.$http.post(url, self.filtros).then((response) => {
                    self.projeto_produtos = response.data;
                    self.qtdeProjetoProduto = self.projeto_produtos.data.length;

                    if (self.qtdeProjetoProduto < 1) {
