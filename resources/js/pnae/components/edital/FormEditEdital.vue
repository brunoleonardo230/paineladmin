                                ...
                                <div class="m-form__section m-form__section" style="margin: 0px 0 0px 0;">
                                    ...
                                    <div class="form-group m-form__group row">
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            ...
                                            <select class="form-control m-input" v-model="produto_aux.has_produto" id="produto" name="produto">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr v-else v-for="(produto, index) in edital.edital_has_produto">
                                                            <td class="align-middle">
                                                                {{ produto.has_produto.produto_id }}
                                                            </td>
                                                            <td class="align-middle">
                                                                {{ produto.has_produto.produto }}
                                                            </td>
                                                            <td class="align-middle">
                                                                {{ produto.quantidade }}{{ produto.has_produto.has_unidade_medida.sigla }}
                                                            </td>
                                                            <td class="align-middle">
    ...
    export default {
        ...
        methods : {
            editarProduto : function(index, produto){
                this.produto_aux = produto;
                this.produto_aux.key = index;
                // console.log(this.produto_aux);
            },
            ...
            addProduto : function(){
                ...
                if (self.produto_aux.key == null) {
                    self.edital.edital_has_produto.forEach(function(p){
                        if (self.produto_aux.has_produto.produto_id == p.produto_id) {
                            comp = true;
                            return Swal({
                                type: 'error',
                                title: 'Atenção',
                    ...
                    if (!comp) {
                        self.produto_aux.produto_id = self.produto_aux.has_produto.produto_id;
            ...
            checkProduto : function(){
                if (this.produto_aux.has_produto == '') {
                    Swal({
                        type: 'error',
                        title: 'Atenção',
