...
-- Started on 2020-02-17 21:31:35
...
--
-- TOC entry 306 (class 1255 OID 24577)
...
--
-- TOC entry 293 (class 1259 OID 26108)
-- Name: tb_cliente; Type: TABLE; Schema: geral; Owner: postgres
--

CREATE TABLE geral.tb_cliente (
    int_cliente_id integer NOT NULL,
    str_nome character varying NOT NULL,
    dta_data_inicio_contrato date NOT NULL,
    bol_ativo boolean DEFAULT true NOT NULL,
    created_at timestamp without time zone,
    updated_at timestamp without time zone
);
...
ALTER TABLE geral.tb_cliente OWNER TO postgres;

--
-- TOC entry 292 (class 1259 OID 26106)
-- Name: tb_cliente_int_cliente_id_seq; Type: SEQUENCE; Schema: geral; Owner: postgres
--

CREATE SEQUENCE geral.tb_cliente_int_cliente_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE geral.tb_cliente_int_cliente_id_seq OWNER TO postgres;

--
-- TOC entry 3164 (class 0 OID 0)
-- Dependencies: 292
-- Name: tb_cliente_int_cliente_id_seq; Type: SEQUENCE OWNED BY; Schema: geral; Owner: postgres
--

ALTER SEQUENCE geral.tb_cliente_int_cliente_id_seq OWNED BY geral.tb_cliente.int_cliente_id;
...
--
-- TOC entry 2944 (class 2604 OID 24674)
...
--
-- TOC entry 2946 (class 2604 OID 24675)
...
--
-- TOC entry 2960 (class 2604 OID 26111)
-- Name: tb_cliente int_cliente_id; Type: DEFAULT; Schema: geral; Owner: postgres
--

ALTER TABLE ONLY geral.tb_cliente ALTER COLUMN int_cliente_id SET DEFAULT nextval('geral.tb_cliente_int_cliente_id_seq'::regclass);


--
-- TOC entry 2947 (class 2604 OID 24676)
...
--
-- TOC entry 2948 (class 2604 OID 24677)
...
--
-- TOC entry 2950 (class 2604 OID 24678)
...
--
-- TOC entry 2951 (class 2604 OID 24679)
...
--
-- TOC entry 2952 (class 2604 OID 24680)
...
--
-- TOC entry 2954 (class 2604 OID 24681)
...
--
-- TOC entry 2955 (class 2604 OID 24682)
...
--
-- TOC entry 2957 (class 2604 OID 24683)
...
--
-- TOC entry 2959 (class 2604 OID 24684)
...
--
-- TOC entry 3127 (class 0 OID 24578)
-- Dependencies: 198
...
--
-- TOC entry 3129 (class 0 OID 24586)
-- Dependencies: 200
...
--
-- TOC entry 3155 (class 0 OID 26108)
-- Dependencies: 293
-- Data for Name: tb_cliente; Type: TABLE DATA; Schema: geral; Owner: postgres
--

INSERT INTO geral.tb_cliente VALUES (2, 'Prefeitura de Zé doca', '2020-02-04', true, '2020-02-12 16:22:05', '2020-02-12 16:22:05');
INSERT INTO geral.tb_cliente VALUES (1, 'Prefeitura de Bom Jardim', '2020-02-12', false, '2020-02-12 15:54:35', '2020-02-12 16:33:01');


--
-- TOC entry 3131 (class 0 OID 24592)
-- Dependencies: 202
...
--
-- TOC entry 3133 (class 0 OID 24597)
-- Dependencies: 204
...
--
-- TOC entry 3135 (class 0 OID 24605)
-- Dependencies: 206
...
--
-- TOC entry 3137 (class 0 OID 24614)
-- Dependencies: 208
...
--
-- TOC entry 3139 (class 0 OID 24619)
-- Dependencies: 210
...
INSERT INTO geral.tb_perfil_permissao VALUES (44, 763);
...
INSERT INTO geral.tb_perfil_permissao VALUES (1, 758);
INSERT INTO geral.tb_perfil_permissao VALUES (44, 765);
INSERT INTO geral.tb_perfil_permissao VALUES (44, 764);
...
INSERT INTO geral.tb_perfil_permissao VALUES (44, 762);
INSERT INTO geral.tb_perfil_permissao VALUES (44, 766);
...
INSERT INTO geral.tb_perfil_permissao VALUES (1, 759);
INSERT INTO geral.tb_perfil_permissao VALUES (1, 760);
INSERT INTO geral.tb_perfil_permissao VALUES (1, 761);
...
--
-- TOC entry 3140 (class 0 OID 24622)
-- Dependencies: 211
...
INSERT INTO geral.tb_perfil_usuario VALUES (208, 44, '2020-02-17 21:07:01', '2020-02-17 21:07:01');
...
--
-- TOC entry 3141 (class 0 OID 24625)
-- Dependencies: 212
...
INSERT INTO geral.tb_permissao VALUES (758, 'index', 'Página inicial de clientes', '2020-02-12 15:17:16', '2020-02-12 15:17:16', 140);
INSERT INTO geral.tb_permissao VALUES (763, 'contrato', 'página de contrato', '2020-02-16 14:37:00', '2020-02-16 14:37:00', 115);
...
INSERT INTO geral.tb_permissao VALUES (759, 'create', 'criar cliente', '2020-02-12 15:42:29', '2020-02-12 15:42:29', 140);
INSERT INTO geral.tb_permissao VALUES (760, 'edit', 'editar cliente', '2020-02-12 15:42:29', '2020-02-12 15:42:29', 140);
INSERT INTO geral.tb_permissao VALUES (764, 'index', 'página inicial', '2020-02-17 11:50:04', '2020-02-17 11:50:04', 142);
INSERT INTO geral.tb_permissao VALUES (765, 'buscar', 'buscar projetos', '2020-02-17 11:50:04', '2020-02-17 11:50:04', 142);
...
INSERT INTO geral.tb_permissao VALUES (761, 'cliente', 'Salva dados do cliente', '2020-02-12 15:47:38', '2020-02-12 15:47:38', 140);
INSERT INTO geral.tb_permissao VALUES (766, 'projeto-produtos', 'Vinculo de projeto com produtos', '2020-02-17 15:27:56', '2020-02-17 15:27:56', 115);
...
INSERT INTO geral.tb_permissao VALUES (762, 'index', 'Página inicial pnae', '2020-02-13 21:39:45', '2020-02-13 21:39:45', 141);
...
--
-- TOC entry 3143 (class 0 OID 24630)
-- Dependencies: 214
...
INSERT INTO geral.tb_recurso VALUES (140, 1, 1, 'clientes', 'Clientes', 'fa-home', true, 1, '2020-02-12 15:16:49', '2020-02-12 15:16:49');
INSERT INTO geral.tb_recurso VALUES (142, 18, 12, 'ajuste-de-projetos', 'Ajuste de Projetos', 'm-menu__link-bullet m-menu__link-bullet--dot', true, 10, '2020-02-17 11:48:58', '2020-02-17 11:48:58');
...
INSERT INTO geral.tb_recurso VALUES (141, 18, 4, 'index', 'Home', 'fa-home', true, 1, '2020-02-13 21:38:49', '2020-02-13 21:38:49');


--
-- TOC entry 3145 (class 0 OID 24639)
-- Dependencies: 216
...
--
-- TOC entry 3147 (class 0 OID 24647)
-- Dependencies: 218
...
--
-- TOC entry 3148 (class 0 OID 24653)
-- Dependencies: 219
-- Data for Name: tb_usuario; Type: TABLE DATA; Schema: geral; Owner: postgres
--

INSERT INTO geral.tb_usuario VALUES (370, 'teste', 'teste@teste.com', '4655646656', 'teste', '$2y$10$/A3ZvBW2UL7h99cTSsGnn.K5PbpP3L/ABEc9T9cV04YDhs/yCeXJi', true, NULL, '2020-02-12 16:29:07', '2020-02-12 16:29:07', 56654545564, 'teste', true, NULL, NULL, 1, NULL);
INSERT INTO geral.tb_usuario VALUES (208, 'Genilson Santos', 'genilson@mail.com', '', 'genilson', '$2y$10$mEIawoT69JJuHj./gI6swubY14z1Z1jtQ9pwFQVisRs/5euLR5xza', true, '9l9Gr7R20t9NRf1JzRrbQWTh9jRfZJX3183eV4cJZ0UqXXmfT6ts6DAQdnD5', '2018-04-27 16:48:16', '2020-02-17 21:06:32', 80346146372, 'PROMOTOR DE JUSTIÇA    ', false, NULL, '2020-02-17 21:06:32', 1, NULL);
INSERT INTO geral.tb_usuario VALUES (357, 'Antonio Carlos', 'antoniocarlos@mail.com', '4655646656', 'carlos', '$2y$10$mEIawoT69JJuHj./gI6swubY14z1Z1jtQ9pwFQVisRs/5euLR5xza', true, 'de3pwjGxFh0uX5rseR6ECeREpG7IxWnFD2tjMHpfG1RpL59liTeOZcaChlPy', '2019-08-21 11:11:38', '2020-02-12 18:09:25', 89798789778, 'treinamento', true, NULL, '2019-09-09 16:48:36', 1, NULL);
INSERT INTO geral.tb_usuario VALUES (210, 'Jesonilton', 'jesonilton@stc.ma.gov.br', '98999989999999', 'jesonilton', '$2y$10$mEIawoT69JJuHj./gI6swubY14z1Z1jtQ9pwFQVisRs/5euLR5xza', true, 'kd0O1Myu2dm2y1CKL7BUkHI8oE1ZwaTl23ZsMnbqVUhexCL6xuCtjxFIoVwe', '2018-06-19 13:35:19', '2020-02-17 21:08:58', 60621194301, 'Analista', false, NULL, '2020-02-17 21:08:58', 2, NULL);
...
--
-- TOC entry 3149 (class 0 OID 24661)
-- Dependencies: 220
...
--
-- TOC entry 3151 (class 0 OID 24666)
-- Dependencies: 222
...
--
-- TOC entry 3153 (class 0 OID 24671)
-- Dependencies: 224
...
-- Dependencies: 292
-- Name: tb_cliente_int_cliente_id_seq; Type: SEQUENCE SET; Schema: geral; Owner: postgres
--

SELECT pg_catalog.setval('geral.tb_cliente_int_cliente_id_seq', 2, true);
...
SELECT pg_catalog.setval('geral.tb_permissao_int_permissao_id_seq', 766, true);
...
SELECT pg_catalog.setval('geral.tb_recurso_int_recurso_id_seq', 142, true);
...
SELECT pg_catalog.setval('geral.tb_usuario_int_usuario_id_seq', 370, true);
...
--
-- TOC entry 2982 (class 2606 OID 24686)
...
--
-- TOC entry 2984 (class 2606 OID 24688)
...
--
-- TOC entry 2986 (class 2606 OID 24690)
...
--
-- TOC entry 2977 (class 2606 OID 24692)
...
--
-- TOC entry 2963 (class 2606 OID 24694)
...
--
-- TOC entry 2965 (class 2606 OID 24696)
...
--
-- TOC entry 2967 (class 2606 OID 24698)
...
--
-- TOC entry 2969 (class 2606 OID 24700)
...
--
-- TOC entry 2971 (class 2606 OID 24702)
...
--
-- TOC entry 2973 (class 2606 OID 24704)
...
--
-- TOC entry 2980 (class 2606 OID 24708)
...
--
-- TOC entry 2990 (class 2606 OID 24710)
...
--
-- TOC entry 2992 (class 2606 OID 24712)
...
--
-- TOC entry 2988 (class 2606 OID 24714)
...
--
-- TOC entry 2994 (class 2606 OID 24716)
...
--
-- TOC entry 2978 (class 1259 OID 24717)
...
--
-- TOC entry 2995 (class 2606 OID 24718)
...
--
-- TOC entry 2996 (class 2606 OID 24723)
...
--
-- TOC entry 2997 (class 2606 OID 24728)
...
--
-- TOC entry 2998 (class 2606 OID 24733)
...
--
-- TOC entry 2999 (class 2606 OID 24738)
...
--
-- TOC entry 3000 (class 2606 OID 24743)
...
--
-- TOC entry 3001 (class 2606 OID 24748)
...
--
-- TOC entry 3002 (class 2606 OID 24753)
...
--
-- TOC entry 3003 (class 2606 OID 24758)
...
--
-- TOC entry 3004 (class 2606 OID 24763)
...
--
-- TOC entry 3005 (class 2606 OID 24768)
...
-- Completed on 2020-02-17 21:31:36
